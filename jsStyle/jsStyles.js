...
function showTextarea() {
  document.getElementById("portfolioSuggestionsContainer").style.display =
    "block";
}
...
function toggleAdditionalFields() {
  ...
  if (
    relationshipDropdown.value === "lecturer" ||
    relationshipDropdown.value === "employer"
  ) {
    ...
    relationshipDropdown.value === "friends" ||
    relationshipDropdown.value === "public"
  ) {
